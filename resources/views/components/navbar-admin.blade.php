...
<div class="bg-white border-t border-gray-100 px-6 py-3">
    <div class="flex items-center justify-around">
        ...
        <!-- Pertanyaan -->
        <a href="{{ route('admin.pertanyaan.index') }}" class="bottom-item flex flex-col items-center gap-1 {{ $active === 'pertanyaan' ? 'text-[#013880]' : 'text-gray-400 hover:text-[#013880]' }} transition-colors">
            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8.228 9c.549-1.165 2.03-2 3.772-2 2.21 0 4 1.343 4 3 0 1.4-1.278 2.575-3.006 2.907-.542.104-.994.54-.994 1.093m0 3h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
            </svg>
            <span class="text-xs font-medium">Pertanyaan</span>
        </a>
