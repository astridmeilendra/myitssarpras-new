            ...
            <div class="mt-4 pt-3 border-t border-gray-100">
                <div class="relative pl-10">
                    ...
                    <div class="space-y-6">
                            ...
                            <div class="flex justify-between items-start gap-3">
                                <div>
                                    ...
                                    <p class="text-[11px] text-gray-600">
                                        ...
                                        Pengguna dapat menghubungi admin jika ingin
                                        mengakhiri peminjaman lebih awal.
                                    </p>
                                </div>
                                <p class="text-[10px] text-gray-400 whitespace-nowrap">
                                    03-08-2025 / 15.30
                        ...
                        <!-- Step 5 (green) -->
                        <div class="relative">
                            <div class="absolute left-[0.625rem] top-1 w-3 h-3 rounded-full bg-green-600"></div>
                            <div class="flex justify-between items-start gap-3">
                                <div>
                                    <p class="text-xs font-semibold text-gray-900">Peminjaman Selesai</p>
                                    <p class="text-[11px] text-gray-600">
                                        Peminjaman ruangan sudah selesai. Peminjam telah
                                        mengembalikan kunci ruangan ke pihak yang bersangkutan.
                                    </p>
                                </div>
                                <p class="text-[10px] text-gray-400 whitespace-nowrap">
                                    03-08-2025 / 17.10
