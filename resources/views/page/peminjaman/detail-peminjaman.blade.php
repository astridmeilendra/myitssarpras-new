    ...
    <div class="flex-1 overflow-y-auto px-6 py-4">
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-4">
            ...
            <div class="flex items-start justify-between mb-4">
                ...
                <span class="px-3 py-1 rounded-full bg-yellow-100 text-yellow-700 text-xs font-semibold h-fit">
                    Menunggu
                </span>
            </div>
                                ...
                                <div class="flex justify-between items-start gap-3">
                                    <div>
                                        ...
                                        <p class="text-[11px] text-gray-600">
                                            {{ $status->keterangan ?? 'Menunggu persetujuan dari pihak Sarpras.' }}
                                        </p>
                                    </div>
            ...
            <div class="mt-6 space-y-3">
                <button
                    class="w-full py-3 rounded-xl bg-gray-100 text-xs font-semibold text-gray-400 text-center">
                    Batalkan Peminjaman
                </button>
                <a href="{{ route('ruangan.detail', $peminjaman->ruanganid) }}" class="block w-full py-3 rounded-xl bg-blue-600 text-white text-xs font-semibold text-center hover:bg-blue-700 transition-colors">
