...
<div class="w-full h-full flex flex-col bg-white">
    ...
    {{-- BOTTOM NAV --}}
    <div class="mt-auto">
        <div class="h-[65px] flex justify-around items-center border-t border-[#e5e9f0] bg-white">

            <button class="flex flex-col items-center text-[12px] text-[#9aa8b6]">
                <svg class="w-5 h-5 mb-0.5" viewBox="0 0 24 24" fill="none" stroke="currentColor">
                    <path d="M4 11L12 4l8 7" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round" />
                    <path d="M6 10v9h12v-9" stroke-width="1.7" stroke-linecap="round" />
                </svg>
                <span>Home</span>
            </button>
            ...
            <button class="flex flex-col items-center text-[12px] text-[#9aa8b6]">
                <svg class="w-5 h-5 mb-0.5" viewBox="0 0 24 24" fill="none" stroke="currentColor">
                    <circle cx="11" cy="11" r="5" stroke-width="1.7" />
                    <path d="M15.5 15.5 19 19" stroke-width="1.7" stroke-linecap="round" />
                </svg>
                <span>Search</span>
            </button>

            <button class="flex flex-col items-center text-[12px] text-[#0b3a7e] font-semibold">
                <svg class="w-5 h-5 mb-0.5" viewBox="0 0 24 24" fill="none" stroke="currentColor">
                    <circle cx="12" cy="9" r="3" stroke-width="1.8" />
                    <path d="M6 19c1.2-2.4 3.3-3.7 6-3.7s4.8 1.3 6 3.7"
